...
Class Login extends CI_Controller 
{
	...
	*/
	...
	private function init($info)
	{
		...
		$this->session->set_userdata('SINGTEL.user_type', $controller);
		$this->session->set_userdata('SINGTEL.username', $info['username']);
	...
	function logout()
	{
		$this->session->set_userdata('SINGTEL.user_type', NULL);
		$this->session->set_userdata('SINGTEL.username', NULL);
