	...
	<body>
						...
						<table cellspacing="0" cellpadding="2" width="100%" style="padding-right: 10px;">
							...
							<tbody>
								...
								<tr>
									...
									<td>$12.84</td>
									<td>$11.56</td>
									<td><?php $this->Record_model->create_chkbox("c1", "$21.90", isset($answers['c1'])?$answers['c1']:0, "50% off for 6mths<br />[PTFL0161]", TRUE); ?></td>
								</tr>
								<tr>
						...
						<table cellspacing="0" cellpadding="2" width="100%" style="padding-right: 10px;">
							...
							<tbody>
								...
								<tr>
									...
									<td>$9.90</td>
									<td></td>
									<td><?php $this->Record_model->create_chkbox("c2", "$21.90", isset($answers['c2'])?$answers['c2']:0, "50% off for 6mths<br />[PTFL0176]", TRUE); ?></td>
								</tr>
								<tr>
						...
						<table cellspacing="0" cellpadding="2" width="100%" style="padding-right: 10px;">
							...
							<tbody>
								<tr>
									...
									<td></td>
									<td></td>
									<td><?php $this->Record_model->create_chkbox("c3", "$14.90", isset($answers['c3'])?$answers['c3']:0, "[PTFL0418]", TRUE); ?></td>
								</tr>
								<tr>
									<td>Adithya TV</td>
									<td>BTV</td>
						...
						<table cellspacing="0" cellpadding="2" width="100%" style="padding-right: 10px;">
							...
							<tbody>
								<tr>
									...
									<td>$6.42</td>
									<td>$5.35</td>
									<td><?php $this->Record_model->create_chkbox("c4", "$14.90", isset($answers['c4'])?$answers['c4']:0, "[PTFL0424]", TRUE); ?></td>
								</tr>
								<tr>
									<td>Jaya TV</td>
									<td>BTV</td>
						...
						<table cellspacing="0" cellpadding="2" width="100%" style="padding-right: 10px;">
							...
							<tbody>
								...
								<tr>
									...
									<td>$8.56</td>
									<td>$6.42</td>
									<td><?php $this->Record_model->create_chkbox("c5", "$11.00", isset($answers['c5'])?$answers['c5']:0, "50% off 3mths<br />[PTFL0219]", TRUE); ?></td>
								</tr>
								<tr>
									<td>Astro World</td>
									<td>On Dd</td>
						...
						<table cellspacing="0" cellpadding="2" width="100%" style="padding-right: 10px;">
							...
							<tbody>
								...
								<tr>
									...
									<td></td>
									<td></td>
									<td><?php $this->Record_model->create_chkbox("c6", "$29.90", isset($answers['c6'])?$answers['c6']:0, "$19.90 for 3 mths<br />[PTFL0414]", TRUE); ?></td>
								</tr>
								<tr>
									<td>Colors</td>
									<td>BTV</td>
						...
						<table cellspacing="0" cellpadding="2" width="100%" style="padding-right: 10px;">
							...
							<tbody>
								...
								<tr>
									...
									<td></td>
									<td></td>
									<td><?php $this->Record_model->create_chkbox("c7", "$19.90", isset($answers['c7'])?$answers['c7']:0, "$14.90 for 3mths<br />[PTFL0409]", TRUE); ?></td>
								</tr>
								<tr>
									<td>Kalaignar TV</td>
									<td>BTV</td>
						...
						<table cellspacing="0" cellpadding="2" width="100%" style="padding-right: 10px;">
							...
							<tbody>
								...
								<tr>
									...
									<td></td>
									<td></td>
									<td><?php $this->Record_model->create_chkbox("c8", "$16.90", isset($answers['c8'])?$answers['c8']:0, "[PTFL0419]", TRUE); ?></td>
								</tr>
								<tr>
									<td>Sony Max</td>
									<td>BTV</td>
						...
						<table cellspacing="0" cellpadding="2" width="100%" style="padding-right: 10px;">
							...
							<tbody>
								...
								<tr>
									...
									<td>On Dd</td>
									<td>$7.00*</td>
									<td><?php $this->Record_model->create_chkbox("c9", "$19.90", isset($answers['c9'])?$answers['c9']:0, "50% off 6 mths<br />[PTFL0333]", TRUE); ?></td>
								</tr>
								<tr>
		...
		<div class="body">
						...
						<table cellspacing="0" cellpadding="2" width="100%" style="padding-right: 10px;">
							...
							<tbody>
								<tr>
									...
									<td><?php $this->Record_model->create_chkbox("c10", "$29.90", isset($answers['c10'])?$answers['c10']:0, "50% off 6 mths<br />[PTFL0327]", TRUE); ?></td>
								</tr>
								<tr>
									<td></td>
									<td><?php $this->Record_model->create_chkbox("c11", "$29.90", isset($answers['c11'])?$answers['c11']:0, "4 mths free<br />[PTFL0402]", TRUE); ?></td>
								</tr>
								<tr>
									<td>Easy Astro Pack <br /><span class="small_txt">Includes: ESPN STAR Sports, Entertainment Pack and Astro Pack</span></td>
									<td><?php $this->Record_model->create_chkbox("c12", "$29.90", isset($answers['c12'])?$answers['c12']:0, "50% off 6 mths<br />[PTFL0315]", TRUE); ?></td>
								</tr>
							</tbody>
						</table>
						<table cellspacing="0" cellpadding="2" width="100%" style="padding-right: 10px;">
							...
							<tbody>
								<tr>
									<td>Cricket Pack</td>
									<td>BTV</td>
									<td><?php $this->Record_model->create_chkbox("c13", "$39.80", isset($answers['c13'])?$answers['c13']:0, "", TRUE); ?></td>
									<td><?php $this->Record_model->create_chkbox("c14", "$19.90", isset($answers['c14'])?$answers['c14']:0, "", TRUE); ?></td>
									<td><?php $this->Record_model->create_chkbox("c15", "$9.90*", isset($answers['c15'])?$answers['c15']:0, "", TRUE); ?></td>
								</tr>
								<tr>
									<td>Sentanta Rugby</td>
									<td>BTV</td>
									<td><?php $this->Record_model->create_chkbox("c16", "$39.80", isset($answers['c16'])?$answers['c16']:0, "", TRUE); ?></td>
									<td><?php $this->Record_model->create_chkbox("c17", "$19.90", isset($answers['c17'])?$answers['c17']:0, "", TRUE); ?></td>
									<td><?php $this->Record_model->create_chkbox("c18", "$9.90*", isset($answers['c18'])?$answers['c18']:0, "", TRUE); ?></td>
								</tr>
								<tr>
									<td>Goal TV Pack</td>
									<td>BTV</td>
									<td><?php $this->Record_model->create_chkbox("c19", "$3.15**", isset($answers['c19'])?$answers['c19']:0, "", TRUE); ?></td>
									<td></td>
									<td></td>
								</tr>
								<tr>
									<td>ASN (HD)</td>
									<td>BTV-HD</td>
									<td><?php $this->Record_model->create_chkbox("c20", "$39.80", isset($answers['c20'])?$answers['c20']:0, "", TRUE); ?></td>
									<td><?php $this->Record_model->create_chkbox("c21", "$19.90", isset($answers['c21'])?$answers['c21']:0, "", TRUE); ?></td>
									<td><?php $this->Record_model->create_chkbox("c22", "$9.90*", isset($answers['c22'])?$answers['c22']:0, "", TRUE); ?></td>
								</tr>
							</tbody>
						</table>
						...
						<table cellspacing="0" cellpadding="2" width="100%" style="padding-right: 10px;">
							...
							<tbody>
								<tr>
									...
									<td><?php $this->Record_model->create_chkbox("c23", "$29.90", isset($answers['c23'])?$answers['c23']:0, "[PTFL0197]", TRUE); ?></td>
								</tr>
								<tr>
									<td>Combo Pack <br /><span class="small_txt">Includes: ESPN STAR Sports, Entertainment Pack and Jingxuan Pack</span></td>
									<td><?php $this->Record_model->create_chkbox("c32", "$29.90", isset($answers['c32'])?$answers['c32']:0, "1 mth free<br />[PTFL0198]", TRUE); ?></td>
								</tr>
								<tr>
									...
									<td><?php $this->Record_model->create_chkbox("c24", "$29.90", isset($answers['c24'])?$answers['c24']:0, "[PTFL0191]", TRUE); ?></td>
								</tr>
								<tr>
									<td>Astro Combo Pack <br /><span class="small_txt">Includes: ESPN STAR Sports, mioStadium, Entertainment Pack and Astro Pack</span></td>
									<td><?php $this->Record_model->create_chkbox("c33", "$29.90", isset($answers['c33'])?$answers['c33']:0, "1 mth free<br />[PTFL0192]", TRUE); ?></td>
								</tr>
								<tr>
									...
									<td><?php $this->Record_model->create_chkbox("c25", "$44.80", isset($answers['c25'])?$answers['c25']:0, "[PTFL0194] + <br />[PTFL0418]", TRUE); ?></td>
								</tr>
								<tr>
									<td>Tamil Combo Pack (Bharata Combo + Uthayam Pack) <br /><span class="small_txt">Includes: ESPN STAR Sports, mioStadium, Bharata Pack and Uthayam Pack</span></td>
									<td><?php $this->Record_model->create_chkbox("c34", "$44.80", isset($answers['c34'])?$answers['c34']:0, "1 mth free (Bharata combo only)<br />[PTFL0195] + <br />[PTFL0418]", TRUE); ?></td>
								</tr>
							</tbody>
						</table>
					</td>
					<td width="50%" valign="top">
						<table cellspacing="0" cellpadding="2" width="100%" style="padding-right: 10px;">
							...
							<tbody>
								<tr>
									<td>Sports Pack</td>
									<td><?php $this->Record_model->create_chkbox("c26", "$34.90", isset($answers['c26'])?$answers['c26']:0, "1 mth Free<br />[PTFL0294]", TRUE); ?></td>
								</tr>
								<tr>
									<td></td>
									<td><?php $this->Record_model->create_chkbox("c27", "$29.90", isset($answers['c27'])?$answers['c27']:0, "[PTFL0251]", TRUE); ?></td>
								</tr>
							</tbody>
						</table>
						<table cellspacing="0" cellpadding="2" width="100%" style="padding-right: 10px;">
							...
							<tbody>
								<tr>
									...
									<td><?php $this->Record_model->create_chkbox("c28", "$39.90", isset($answers['c28'])?$answers['c28']:0, "[PTFL0298]", TRUE); ?></td>
								</tr>
								<tr>
									<td>Includes: mioStadium &amp; ESS, Entertainment, Jingxuan, Astro,<br />(Obsolete) Bharata, US TV Packs</td>
									<td><?php $this->Record_model->create_chkbox("c31", "$39.90", isset($answers['c31'])?$answers['c31']:0, "1 mth free<br />[PTFL0305]", TRUE); ?></td>
								</tr>
							</tbody>
						</table>
						...
						<table cellspacing="0" cellpadding="2" width="100%" style="padding-right: 10px;">
							...
							<tbody>
								<tr>
									...
									<td></td>
									<td></td>
									<td><?php $this->Record_model->create_chkbox("c29", "$00.00", isset($answers['c29'])?$answers['c29']:0, "[PTFL0279]", TRUE); ?></td>
								</tr>
							</tbody>
						</table>
					</td>
			...
			<div style="width:50%; margin:0px auto;">
				__________________________________________________________________________________<?php $this->Record_model->create_chkbox("c30", "%10", isset($answers['c30'])?$answers['c30']:0, "", TRUE); ?><br />
